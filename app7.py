...
def save_uploaded_file(directory, file) :
    ...
    return st.success(directory + '에' + file.name + '에 파일이 잘 저장되었습니다.')
...
def main() :
    ...
    if choice == 'Image' :
        ...
        file = st.file_uploader('이미지 파일을 업로드하세요', type = ['jpg', 'jpeg', 'png', 'webp', 'jfif'])
        ...
        if file is not None :
            ...
            # csv 파일을 판다스 데이터프레임으로 읽어서 웹화면에 보여준다.
